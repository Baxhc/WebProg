...
<body>
    <div class="container">
        <div class="bg-secondary-subtle p-5 m-5">
            ...
            <form action="{{ url('profile/'.$booking_id.'/'.$customer_id) }}" method="POST">
                @csrf
                @method('DELETE')
                ...
                <a href="#" class="btn btn-lg px-5 m-2" style="background-color: #821616; color: white; font-size: 16px;"><b>Cancel</b></a>
            </form>
            </center>
        </div>
    </div>
